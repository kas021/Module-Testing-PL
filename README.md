...
**New active testing: TVApp Live 0.1.0-beta.3.** (published 2026-09-16; supersedes beta.2 — adds the `streamType` field the app reads, and documents that the provider serves placeholder-image playlists when a channel is not broadcasting) — Live TV guide
