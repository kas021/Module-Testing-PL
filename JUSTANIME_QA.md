...
- Additional exact beta.4 Dub S2 run `2026-09-10T18-56-01-280Z_s2_justanime-v1_1eab329d` was cancelled after the Flutter compiler stalled for almost four minutes. The tool records FAIL / RUNTIME_SUMMARY_MISSING; no Dub runtime or playback result was obtained from that run. Do not count it as passed or as a reproduced source failure. Native Dub/spoken-English confirmation remains pending.
